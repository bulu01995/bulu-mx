...
import { isValidEmail, isValidPassword, isValidPhone, isValidName } from "@/lib/validation"
        ...
        <div className="flex-1 bg-gray-50 flex flex-col justify-center px-8 lg:px-16 relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-lg">
            ...
            <div className="space-y-6">
              <div>
                <h1 className="text-2xl font-semibold text-gray-900 mb-2">Join thousands of satisfied customers</h1>
                <h2 className="text-xl text-gray-700 mb-6">Start your financial journey with us</h2>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-gray-600">Access to exclusive loan offers and credit cards</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-gray-600">Personalized financial recommendations</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-gray-600">24/7 customer support and expert guidance</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex-1 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 flex flex-col justify-center px-8 lg:px-16">
          <div className="max-w-md mx-auto w-full">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-blue-200 text-sm uppercase tracking-wide">CREATE YOUR ACCOUNT</p>
            </div>
            ...
            <form onSubmit={handleSignUp} className="space-y-4">
              ...
              <div className="relative">
                <div className="flex">
                  ...
                  <div className="flex items-center px-3 bg-white border border-r-0">
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription className="text-center text-gray-600">
              Welcome to BULU ENTERPRISES! Your account has been created and you can now access all our services.
            </DialogDescription>
          </DialogHeader>
