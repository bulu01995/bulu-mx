      ...
      <main className="container mx-auto px-6 md:px-12 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-lg">Calculate your loan EMI and total interest payable</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex gap-4">
                  <Button onClick={calculateLoan} className="flex-1 bg-green-600 hover:bg-green-700">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-xl font-semibold">Loan Calculation</CardTitle>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="bg-green-50 p-4 rounded-lg">
                  <div className="text-sm text-gray-600 mb-1">{t("monthlyEMI")}</div>
                  <div className="text-3xl font-bold text-green-600">₹ {results.monthlyEMI.toLocaleString()}</div>
                </div>

                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-blue-50 p-4 rounded-lg">
                    <div className="text-sm text-gray-600 mb-1">{t("totalInterest")}</div>
                    <div className="text-xl font-bold text-blue-600">₹ {results.totalInterest.toLocaleString()}</div>
                  </div>
